...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    let [etiquetas, etiquetas_metadata] = await queryInterface.sequelize.query('SELECT id FROM etiqueta')
    ...
    await queryInterface.bulkInsert('fotoetiquetas', [
      ...
      { foto_id: fotos[8].id, etiqueta_id: etiquetas[0].id, createdAt: new Date(), updatedAt: new Date() },
      { foto_id: fotos[9].id, etiqueta_id: etiquetas[7].id, createdAt: new Date(), updatedAt: new Date() },
